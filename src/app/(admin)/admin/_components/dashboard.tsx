...
const CustomTooltip = ({
  ...
  return (
    <div className="bg-white dark:bg-neutral-800 border rounded-md px-3 py-2 shadow-md text-sm">
...
export function Dashboard({ initialData }: { initialData: any }) {
  ...
  const chartData = [
    {
      status: `Pending (${(testDrives.pending / testDrives.total) * 100}%)`,
      count: testDrives.pending,
      fill: "hsl(var(--chart-4))",
    },
    {
      status: `Confirmed (${(testDrives.confirmed / testDrives.total) * 100}%)`,
      count: testDrives.confirmed,
      fill: "hsl(var(--chart-2))",
    },
    {
      status: `Completed (${(testDrives.completed / testDrives.total) * 100}%)`,
      count: testDrives.completed,
      fill: "hsl(var(--chart-3))",
    },
    {
      status: `Cancelled (${(testDrives.cancelled / testDrives.total) * 100}%)`,
      count: testDrives.cancelled,
      fill: "hsl(var(--chart-1))",
    },
    {
      status: `Pending (${(testDrives.noShow / testDrives.total) * 100}%)`,
              ...
              <div className="space-y-6">
                ...
                <Tabs defaultValue="bar" className="w-full">
                  <TabsList className="grid w-full grid-cols-2">
                    <TabsTrigger value="bar">Graphical</TabsTrigger>
