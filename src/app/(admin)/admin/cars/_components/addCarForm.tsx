...
export const AddCarForm = () => {
  ...
  useEffect(() => {
    if (processImageResult?.success && processImageResult?.data) {
      ...
      if (uploadedAiImage) {
        ...
        reader.onload = (e) => {
          ...
          if (target && target.result) {
            // Check if target and result are not null
      ...
      toast.success("Successfully extracted car details", {
        description: `Detected ${carDetails.year} ${carDetails.brand} ${carDetails.model}`,
      });
  ...
  const onSubmit = async (data: CarFormData) => {
    ...
    const seats =
      data.seats === undefined || data.seats === null ? "" : data.seats; // Convert undefined or null to empty string
