...
type FormData = z.infer<typeof testDriveSchema>;
...
export function TestDriveForm({ car, testDriveInfo }: TestDriveFormProps) {
  ...
  useEffect(() => {
    if (bookingResult?.success && bookingResult?.data) {
      const { bookingDate, startTime, endTime, notes } = bookingResult.data;
  ...
  useEffect(() => {
    ...
    setValue("timeSlot", "");
  }, [selectedDate, dealership?.workingHours, testDriveInfo?.existingBookings, setValue]);
            ...
            <div className="py-4">
              <div className="space-y-3">
                ...
                <div className="flex justify-between">
                  ...
                  <span>{dealership?.name || "Autora Motors"}</span>
                </div>
              </div>
