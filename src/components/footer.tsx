...
export const Footer = () => {
  return (
    <footer className="py-4 flex flex-col sm:flex-row items-center justify-between px-4 sm:px-8 z-50">
      <p className="text-sm text-gray-600">
        &copy; {new Date().getFullYear()} Autora. All rights reserved.
      </p>
      <p className="text-sm text-gray-600">Project by Vedant Uekey</p>
